...
<head>
    ...
    <title>Login User | Sistem Informasi Arsip Digital Pengadilan Negeri Takengon Kelas II</title>
    ...
    <div class="error-pagewrap">
        <div class="error-page-int">
            ...
            <div class="text-center login-footer">
                <p class="text-muted">CDesign© Teguh Yudhiasnyah<?php echo date('Y') ?>. Sistem Informasi Arsip Digital. Pengadilan Negeri Takengon Kelas II</p>
            </div>
        </div>   
    </div>
