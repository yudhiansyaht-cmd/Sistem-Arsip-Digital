...
<head>
    ...
    <title>Petugas - Sistem Informasi Arsip Digital Pengadilan Negeri Takengon Kelas II</title>
    ...
    <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header">
                <a href="index.html"><img class="main-logo" src="../assets/img/logo/pn1.png" alt="" /></a>
                                    ...
                                    <div class="col-lg-5 col-md-6 col-sm-12 col-xs-12">
                                        <div class="header-top-menu tabl-d-n">
                                            <ul class="nav navbar-nav mai-top-nav">
                                                <li class="nav-item"><a href="#" class="nav-link">Sistem Informasi Arsip Digital Pengadilan Negeri Takengon Kelas II</a></li>
                                            </ul>
                                        </div>
                                    </div>
