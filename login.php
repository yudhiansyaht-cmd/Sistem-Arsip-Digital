...
<head>
    ...
    <title>Login Administrator | Sistem Informasi Arsip Digital Pengadilan Negeri Takengon Kelas II</title>
...
<body>
    <div class="error-pagewrap">
        <div class="error-page-int">
            <div class="text-center m-b-md custom-login">
                <h3>ARSIP DIGITAL</h3>
                <h4>Sistem Informasi Arsip Digital Pengadilan Negeri Takengon Kelas II</h4>
            ...
            <div class="text-center login-footer">
                <p class="text-muted">Design Teguh Yudhiasnyah © <?php echo date('Y') ?>.Sistem Informasi Arsip Digital. Pengadilan Negeri Takengon Kelas II)</p>
            </div>
        </div>   
    </div>
	...
	<body class="hold-transition login-page" style="background:url(gambar/depan/ini.jpg)
